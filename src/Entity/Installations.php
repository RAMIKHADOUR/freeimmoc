...
class Installations
{
    ...
    #[ORM\Column(nullable: true)]
    private ?bool $Caméra_surveillance = null;
    ...
    public function isCaméraSurveillance(): ?bool
    {
        return $this->Caméra_surveillance;
    }

    public function setCaméraSurveillance(?bool $Caméra_surveillance): static
    {
        $this->Caméra_surveillance = $Caméra_surveillance;
