...
#[Route('/installations')]
class InstallationsController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('installations/new.html.twig', [
    ...
    public function edit(Request $request, Installations $installation, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('installations/edit.html.twig', [
            'installation' => $installation,
            'form' => $form,
        ]);
    }
